...
6. После подключения домашние устройства и все существующие WireGuard-доступы открываются без повторного ввода пароля. При желании подключите Collector — только для локальной истории WireGuard.
